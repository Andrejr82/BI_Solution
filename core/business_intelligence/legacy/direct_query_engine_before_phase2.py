...
class DirectQueryEngine:
    ...
    def _query_produtos_sem_vendas(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_estoque_parado(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_consulta_produto_especifico(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_preco_produto_une_especifica(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_top_produtos_une_especifica(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_vendas_une_mes_especifico(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_ranking_vendas_unes(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_produto_mais_vendido_cada_une(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_top_produtos_por_segmento(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_top_produtos_segmento_une(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_top_produtos_categoria_une(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_evolucao_vendas_produto(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_produto_vendas_une_barras(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_produto_vendas_todas_unes(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _query_ranking_geral(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        if tem_une and (tem_nome_categoria or tem_categoria):
            ...
            if categoria_detectada and une_detectada:
                ...
                return self._query_top_produtos_categoria_une(adapter, {
                    'limite': limite,
    ...
    def _query_consulta_une_especifica(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_ranking_fabricantes(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_comparacao_segmentos(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
        Compara vendas entre 2 ou mais segmentos.

        Args:
            adapter: ParquetAdapter com dados
    ...
    def _query_analise_abc(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_estoque_alto(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_distribuicao_categoria(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_diversidade_produtos(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_crescimento_segmento(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_sazonalidade(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_ranking_unes_por_segmento(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_vendas_produto_une(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_evolucao_mes_a_mes(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_pico_vendas(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_tendencia_vendas(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_produtos_acima_media(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_performance_categoria(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_comparativo_unes_similares(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_fabricantes_novos_vs_estabelecidos(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_fabricantes_exclusivos_multimarca(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_ciclo_vendas_consistente(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_estoque_baixo_alta_demanda(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_leadtime_vs_performance(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_rotacao_estoque_avancada(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_exposicao_vs_vendas(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_estoque_cd_vs_vendas(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _query_analise_geral(self, adapter: ParquetAdapter, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if any(kw in user_query for kw in ['abc', 'curva abc', 'classificação abc', 'classe a', 'classe b', 'classe c']):
            ...
            return self._query_analise_abc(adapter, params)
        ...
        if any(kw in user_query for kw in ['sazonalidade', 'sazonal', 'sazonais', 'padrão sazonal', 'variação mensal']):
            ...
            return self._query_sazonalidade(adapter, params)
        ...
        if any(kw in user_query for kw in ['crescimento', 'cresceu', 'aumentou', 'evolução', 'crescente']):
            ...
            return self._query_crescimento_segmento(adapter, params)
        ...
        if any(kw in user_query for kw in ['tendência', 'tendencia', 'trend', 'projeção']):
            ...
            return self._query_tendencia_vendas(adapter, params)
        ...
        if any(kw in user_query for kw in ['pico', 'máximo', 'maximo', 'maior venda', 'record']):
            ...
            return self._query_pico_vendas(adapter, params)
        ...
        if any(kw in user_query for kw in ['concentração', 'concentracao', 'dependência', 'dependencia', 'diversificação', 'diversificacao']):
            ...
            return self._query_diversidade_produtos(adapter, params)
        ...
        if any(kw in user_query for kw in ['distribuição', 'distribuicao', 'categoria', 'categorias']):
            ...
            return self._query_distribuicao_categoria(adapter, params)
        ...
        if any(kw in user_query for kw in ['estoque alto', 'excesso de estoque', 'estoque parado', 'muito estoque']):
            ...
            return self._query_estoque_alto(adapter, params)
        ...
        if any(kw in user_query for kw in ['acima da média', 'acima da media', 'superam', 'ultrapassam']):
            ...
            return self._query_produtos_acima_media(adapter, params)
        ...
        if any(kw in user_query for kw in ['top', 'ranking', 'melhores', 'maiores', 'principais']):
            ...
            return self._query_ranking_geral(adapter, params)
        ...
        if any(kw in user_query for kw in ['comparar', 'comparação', 'comparacao', 'versus', 'vs', 'entre']):
            ...
            return self._query_comparacao_segmentos(adapter, params)
        ...
        if any(kw in user_query for kw in ['evolução', 'evolucao', 'mês a mês', 'mes a mes', 'mensal']):
            ...
            return self._query_evolucao_mes_a_mes(adapter, params)
