...
class DuckDBEnhancedAdapter:
    ...
    def _initialize(self):
        ...
        # ✅ FIX 2026-01-14: Flag para tabela em memória (Context7 Performance)
    ...
    def load_parquet_to_memory(self, parquet_name: str, table_name: str = None) -> str:
        """
        ✅ CONTEXT7 PERFORMANCE: Carrega Parquet em TABELA em memória.
        ...
        # ✅ CRIAR TABELA EM MEMÓRIA (não VIEW!)
        ...
        logger.info(f"✅ [MEMORY] Tabela {table_name} carregada: {count:,} registros em {duration:.2f}s")
        return table_name
    ...
    def get_cached_parquet(self, parquet_name: str) -> str:
        ...
        ✅ CONTEXT7 FIX: Agora usa TABELA em memória ao invés de VIEW.
        ...
        """
        # ✅ FIX 2026-01-14: Usar tabela em memória ao invés de VIEW
    ...
    def load_data(
        ...
        """
        ✅ CONTEXT7: Query otimizada na tabela em memória.
    ...
    def execute_aggregation(
        ...
        """
        ✅ CONTEXT7: Agregação otimizada na tabela em memória.
